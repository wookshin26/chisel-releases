...
2. Before `start_internal_review`, warn that approval can trigger paid model calls. Supply the exact baseline ref, selected persona IDs, provider, and model; never use this skill to create, import, or transfer External review points because External review is outside this plugin scope.
