...
export async function connectHttpEndpoint(discovery) {
  const client = new Client({ name: 'chisel-claude-code-bridge', version: BRIDGE_VERSION })
...
export function createBridgeApplication(options = {}) {
  ...
  const server = new Server(
    { name: 'chisel', version: BRIDGE_VERSION },
    {
      ...
      instructions:
        'Connects Claude Code to the Chisel desktop app. Chisel must be open with its MCP server enabled; edits and runs remain parked for in-app approval.'
    }
  )
